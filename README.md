...
git init
git add .
git commit -m "Initial commit: Μαθηματικά Πληροφορικής notes"

# Δημιουργία public repo στο GitHub
gh repo create math-info-notes --public --source=. --push
```

Ή μέσω GitHub web UI: New Repository → Public → push existing.

### Βήμα 2 — Ενεργοποίηση GitHub Pages
...
```text
https://YOUR-USERNAME.github.io/math-info-notes/
```
...
Το GitHub Pages αναπτύσσεται αυτόματα σε ~30 δευτερόλεπτα.
...
```bash
# Χωρίς server (ανοίγει άμεσα)
open index.html        # macOS
xdg-open index.html   # Linux

# Ή με Python HTTP server
cd math-info-notes
python -m http.server 8000
# → Άνοιξε: http://localhost:8000
```

> **Σημείωση:** Ορισμένα browser security settings μπλοκάρουν `file://` requests.
> Χρησιμοποιήστε τον Python server για πλήρη λειτουργικότητα.
